...
$updateHODRatingsQuery = "UPDATE section_v set Activity1HR = '$varA1HR',Activity2HR = '$varA2HR',Activity3HR = '$varA3HR',Activity4HR = '$varA4HR',Activity5HR = '$varA5HR',TotalHodRating = '$varTotalHodRating' where Userid = '$varUserId' ";
