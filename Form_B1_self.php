               ...
               <div class="profile-info col-md-12 col-lg-9">
                    ...
                    <div class="panel">
                         ...
                         <div class="panel-body bio-graph-info">
                              ...
                              <form action="controllers/formB1empRatingController.php"
                                   method="POST">
                                   <div class="row">
                                             ...
                                             <table class="table ">
                                                  ...
                                                  <tbody>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style = "text-align: justify">
                                                                      <div style = "text-align: justify">Percentage of lectures,
                                                                           ...
                                                                           <input type="text" plcaeholder="title of allocated courses" name="titleCourses"
                                                                                style="border-color: gray;" />
                                                                           <br>
                                                                           No. of Lectures allocated:
                                                                           <input type="number" name="a_lectures"
                                                                                style="border-color: gray;" />
                                                                           <br>
                                                                           No. of Lectues taken:
                                                                           <input type="number" name="t_lectures"
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style = "text-align: justify">
                                                                      <div style = "text-align: justify">Percentage of Seminars,
                                                                           ...
                                                                           semesters:
                                                                           <input type="text" placeholder="Enter title of practicals assigned" name="titlePractical"
                                                                                style="border-color: gray;" />
                                                                           <br>
                                                                           No. of Seminars, tutorials,
                                                                           practicals allocated:
                                                                           <input type="number" name="a_practicals"
                                                                                style="border-color: gray;" />
                                                                           <br>
                                                                           No. of
                                                                           Seminars, tutorials, practicals taken:
                                                                           <input type="number" name="t_practicals"
                                                                                style="border-color: gray;" />
                                                                      </div>
                                                                 </div>
                                                            </td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style = "text-align: justify">
                                                                      <div style = "text-align: justify">University final results
                                                                           for the subjects
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style = "text-align: justify">
                                                                      <div style = "text-align: justify">Student Feedback for
                                                                           both the semesters -
