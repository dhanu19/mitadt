            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="left-heading">
                        <h2 class="section-title">About MIT Art, Design, & Technology University, Rajbaug, Pune</h2>
                    </div>
                    <div class="left-text">
                        <p>Creativity and innovation co-exist and thrive at MIT-ADT University, Pune. Located at Rajbaug Campus, Loni Kalbhor, the award-winning campus spans over 100 acres of greenery and inspiration. The private University is established as per the Government and University Act and offers Undergraduate, Post-Graduate and Doctoral degrees in Art, Design, and Technology through industry-focused programs</p>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-bottom-fix">
                    ...
                    <div class="left-text">
                    <p>1)100+ Acres of Inspiring Campus<br>2)113+ Courses<br>3)20+ Foreign University Collaborations<br>4)300+ Campus Recruiters<br>5)110+ Faculty Mentors<br>6)26+ Patents<br></p>
                    </div>
                </div>
                <div class="col-lg-1"></div>
            ...
            <div class="row">
                    ...
                    <div class="team-item">
                        <div class="team-content">
                            ...
                            <p>1)Industry experts delivering value added programme<br>
                               2)Believes and practices Indian Culture, Values & Ethos to promote World Peace<br>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="team-item">
                        <div class="team-content">
                            <i><img src="assets/images/testimonial-icon.png" alt=""></i>
                            <p>1)Training and Placement (T&P) Cell to help secure the best prospects with reputable MNCs around the world; offering 100 percent placement assistance to graduating students<br>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="text">
                                Only State Private University to get recognized by NITI Aayog, Govt. of India for ATAL Innovation Mission.
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <ul class="social">
                        <li><a href="https://www.facebook.com/mitadtuniversity/"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.instagram.com/mitadtuniversity/?hl=en"><i class="fa fa-instagram"></i></a></li>
