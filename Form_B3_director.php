               ...
               <div class="profile-info col-md-12 col-lg-9">
                    ...
                    <div class="panel">
                         ...
                         <div class="panel-body bio-graph-info">
                              ...
                              <a
                                   href="Form_B4_director.php?userId=<?php echo $_GET['userId'];?>"><button>Next</button></a>
                         </div>
                         <?php }
                         else{ ?>
                         <div class="panel-body bio-graph-info">
                                                    ...
                                                    ?>
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style = "text-align: justify;"><b>Students Mentorship:</b><br>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style = "text-align: justify;">Involvement in development of the
