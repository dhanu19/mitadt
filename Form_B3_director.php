          ...
          <div class="profile-info col-md-12 col-lg-9">
               ...
               <div class="panel">
                    ...
                    <div class="container" style="padding-top:10px; text-align:left;">
                         <h5>CO-CURRICULAR, EXTENSION AND PROFESSIONAL DEVELOPMENT RELATED ACTIVITIES</h5>
                    </div>
                    <br>
                    <?php
                    ...
                    <div class="panel-body bio-graph-info">
                         ...
                         <a href="Form_B4_director.php?userId=<?php echo $_GET['userId'];?>"><button>Next</button></a>
                    </div>
                    <?php }
                         else{ ?>
                    <div class="panel-body bio-graph-info">
                                        ...
                                        <table class="table ">
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>
                                                            <div style="text-align: center;">
                                                                 <input type="number" placeholder="0-5" aria-label="0-5"
                                                                      min="0" max="5" style="width: 135px;"
                                                                      name="Activity2PR"
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td style="text-align: left;">
                                                            <div style="text-align: justify;">Involvement in development
                                                                 of the
