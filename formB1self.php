                         ...
                         <form action="controllers/form_data_validation.php" method="POST">
                              <div class="panel-body bio-graph-info">
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="bio-row">
                                             <p><span>No. of Children</span> <input class="input" name="noOfChildren" />
                                             </p>
                                        </div>
                                        <div class="bio-row">
                                        ...
                                        <div class="bio-row">
                                             <p><span>No of Dependents</span> <input class="input" name="dependents" />
                                             </p>
                                        </div>
                                        <div class="bio-row">
                                        ...
                                        <div class="bio-row">
                                             <p><span>Email </span><input type="email" class="form-control"
                                                       placeholder="" name="email" aria-label=""></p>
                                        </div>
                                        <div class="bio-row">
                                             <p><span>Mobile </span><input type="number" class="form-control"
                                                       placeholder="" name="mobile" aria-label=""></p>
                                        </div>
