                        ...
                        <div class="row">
                            <div class="panel-body bio-graph-info" style="background-color:white">
                                ...
                                <table class="table ">
                                    ...
                                    <thead>
                                        <tr>
                                            <th scope="col" style="text-align: left; width: 100px;">Section number </th>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" placeholder="0-20" aria-label="0-20" min="0" max="20"
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" placeholder="0-10" aria-label="0-10" min="0" max="10"
                                                        style="width: 135px;"></td>
