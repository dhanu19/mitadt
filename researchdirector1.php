               ...
               <div class="profile-info col-md-9">
                    ...
                    <div class="panel">
                         ...
                         <div class="panel-body bio-graph-info">
                              ...
                              <a
                                   href="cocurriculardirector1.php?userId=<?php echo $_GET['userId'];?>"><button>Next</button></a>
                         </div>
                         <?php }
                         else{ ?>
                         <div class="panel-body bio-graph-info">
                              <form action="controllers/formB2PrincipalRatingController.php?userId=<?php echo $_GET['userId']; ?>"
                                   ...
                                   <div class="row">
                                        <div class="panel-body bio-graph-info" style="background-color:white">
                                             ...
                                             <h3 style="color:black;"> Research , publications & Academic Contributions:
                                             </h3>
                                                    ...
                                                    ?>
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div align="justify"><b> Research Publications </b>
                                                                      Number
