               ...
               <div class="profile-info col-md-12 col-lg-9">
                    ...
                    <div class="panel">
                         ...
                         <div class="container" style="padding-top:10px; text-align:left;">
                              <h5>TEACHING, RESEARCH, PUBLICATIONS & ACADEMIC CONTRIBUTIONS</h5>
                         </div>
                         <br>
                         <?php
                         ...
                         <div class="panel-body bio-graph-info">
                              ...
                              <a href="cocurricularhod1.php"><button>Next</button></a>
                         </div>
                         <?php }
                         else{ ?>
                         <div class="panel-body bio-graph-info">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    ?>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style="text-align: justify;">
                                                                      <div style="text-align: justify;">Sponsored/
                                                                           Funded Projects/
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style="text-align: justify;">
                                                                      <div style="text-align: justify;"><b>Involvement
                                                                                in student
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div style="text-align: justify;">
                                                                      <div style="text-align: justify;">Contribution in
                                                                           conducting
                                                                           the
                                                                 ...
                                                                 <div style="text-align: center;">
                                                                      <div style="text-align: center;">
                                                                           <input name="number5" type="number"
                                                                                ...
                                                                                value="<?php echo $rowRatings['TotalHODRating']; ?>">
                                                                      </div>
                                                                 </div>
                                                            </td>
                                                       </tr>
