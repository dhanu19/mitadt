          ...
          <div class="profile-info col-md-12 col-lg-9">
               <div class="panel">
                    ...
                    <<<<<<< HEAD </div>
                         ...
                         <br>
                         <div class="panel">
                              >>>>>>> 641cdb6411b946beabc1d8ef807f9a0dc4280613
                              ...
                              <div class="panel-body bio-graph-info">
                                   <<<<<<< HEAD <form
                                        action="controllers/formB5PrincipalRatingController.php?userId=<?php echo $_GET['userId']; ?>"
                                        method="POST">
                                        <div class="row">
                                             <div class="panel-body bio-graph-info">
                                                  ...
                                                  <table class="table table-striped ">
                                                       <thead>
                                                            <tr>
                                                                 <th scope="col" style="text-align: center;">Sr. No.
                                                                 </th>
                                                       ...
                                                       <tbody>
                                                            <tr>
                                                                 ...
                                                                 <td style="text-align: center;">
                                                                      <div style="text-align: justify;">Punctuality
                                                                      </div>
                                                                 </td>
                                                                 <td>
                                                            ...
                                                            <tr>
                                                                 ...
                                                                 <td style="text-align: center;">
                                                                      <div style="text-align: justify;">Interpersonal
                                                                           Skills</div>
                                                                 </td>
                                                            ...
                                                            <tr>
                                                                 ...
                                                                 <td style="text-align: center;">
                                                                      <div style="text-align: justify;">Institutional
                                                                           Development
                                                                           contributors</div>
                                                                 </td>
                                             ...
                                             <div class="row">
                                                  <div class="panel-body bio-graph-info">
                                                       ...
                                                       <table class="table ">
                                                            <thead>
                                                                 <tr>
                                                                      <th scope="col" style="text-align: center;">Sr.
                                                                           No. </th>
                                                                      <th scope="col" style="text-align: center;">
                                                                           <div style="text-align: justify;">Parameters
                                                                           </div>
                                                                      </th>
                                                                      <th scope="col" style="text-align: center;">Self
                                                                           Rating</th>
                                                            ...
                                                            <tbody>
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td style="text-align: center;">
                                                                           <div style="text-align: justify;">
                                                                                Institutional Development contributors
                                                                           </div>
                                                                      </td>
                                                                      <td>
                                                                           <div style="text-align: center;">
