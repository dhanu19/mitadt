               ...
               <div class="profile-info col-md-9">
                    ...
                    <div class="panel">
                         ...
                         <div class="panel-body bio-graph-info">
                              ...
                              <a
                                   href="researchdirector1.php?userId=<?php echo $_GET['userId'];?>"><button>Next</button></a>
                         </div>
                         <?php }
                         else{ ?>
                         <div class="panel-body bio-graph-info">
                                                    ...
                                                    ?>
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div allign="justify">
                                                                      <div align="justify">Percentage of lectures,
                                                                           contact
                                                                           hours undertaken during both the semesters
                                                                           (100%
                                                                           compliance = 25), Title of the courses in
                                                                           both
                                                                           semesters: - No. of Lectures
                                                                           allocated:-------------- No. of Lectues
                                                                           taken:-------------
                                                                      </div>
                                                                 </div>
                                                            </td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div allign="justify">
                                                                      <div align="justify">Percentage of Seminars,
                                                                           Tutorials,
                                                                           Practicals, etc. or other teaching duties
                                                                           other
                                                                           than actual conducted (100% compliance = 25)
                                                                           Title
                                                                           of the practicals in both semesters:----- No.
                                                                           of
                                                                           Seminars, tutorials, practicals
                                                                           allocated:-----
                                                                           No. of Seminars, tutorials, practicals
                                                                           taken:-----
                                                                      </div>
                                                                 </div>
                                                            </td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div allign="justify">
                                                                      <div align="justify">Use of participatory and
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div allign="justify">
                                                                      <div align="justify">Examination duties
                                                                           (Invigilation,
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div allign="justify">
                                                                      <div align="justify">University final results for
                                                                           the
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                 <div allign="justify">
                                                                      <div align="justify">Student Feedback for both the
